...
export function CellContentLoader({rows = 10, cols = 4, title = 'Loading Data',
	backgroundColor = "#E4E5E6", foregroundColor = "#ffffff", speed = 1.2, header = true, size = 'lg' }, props) {

	let rectangles = [],
		width = size === 'lg' ? 900 : 400,
		headRect = [[0, 0, width, 17],
					[0, 35, width, 17]],
		y = -10;
	...
	for (let i = 0; i < rows ; i++){
		if(cols === 1) {
			rectangles.push([width*0.05 , y + 20 + (i * 55), width*0.9 , 15],
							)
			headRect.push([0, 12, width * 0.15, 33],
						[width*0.85, 12, width * 0.15, 33],
						)
		}
		if(cols === 2) {
			rectangles.push([width*0.05 , y + 20 + (i * 55), width*0.425 , 15],
							[width*0.525 , y + 20 + (i * 55), width*0.425 , 15],
							[width*0.01, y + (i * 55), width*0.98, 2]
						)
			headRect.push([0, 12, width * 0.1, 33],
							[width*0.4, 12, width * 0.2, 33],
							[width*0.9, 12, width * 0.15, 33],
						)
		}
		if(cols === 3) {
			rectangles.push([width*0.05 , y + 20 + (i * 55), width*0.85/3 , 15],
		...
		if(cols === 4) {
			rectangles.push([width*0.05 , y + 20 + (i * 55), width*0.85/4, 15], 
		...
		if(cols === 5) {
			rectangles.push([width*0.05 , y + 20 + (i * 55), width*0.85/5, 15], 
			...
			headRect.push([0, 12, width * 0.075, 33],
